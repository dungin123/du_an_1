...
import com.example.duanmotnhom12.Adapter.AdminViewHoaDonChiTietAdapter;
...
public class JsonHoaDonChiTietAdmin {
    public static AdminViewHoaDonChiTietAdapter adminViewHoaDonChiTietAdapter;
    ...
    public void getHoaDonChiTietAdmin(String url, Context context, RecyclerView view) {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Log.d("aaacs", jsonObject.getString("id_HoaDon_"));
                        modelHoaDonChiTiets.add(modelHoaDonChiTiet);
                    }

                    adminViewHoaDonChiTietAdapter = new AdminViewHoaDonChiTietAdapter(context, modelHoaDonChiTiets);
                    view.setAdapter(adminViewHoaDonChiTietAdapter);
                    adminViewHoaDonChiTietAdapter.notifyDataSetChanged();
