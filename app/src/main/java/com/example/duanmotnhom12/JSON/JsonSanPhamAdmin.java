...
import com.example.duanmotnhom12.Adapter.ListSanPhamAdapterAdmin;
...
public class JsonSanPhamAdmin {
    public static ListSanPhamAdapterAdmin listSanPhamAdapterAdmin;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    listSanPhamAdapterAdmin = new ListSanPhamAdapterAdmin(context, modelSanPhams);
                    view.setAdapter(listSanPhamAdapterAdmin);
                    listSanPhamAdapterAdmin.notifyDataSetChanged();
